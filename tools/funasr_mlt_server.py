...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--remote-code", default=os.getenv("FUNASR_REMOTE_CODE", ""))
...
class Runtime:
    def __init__(self, args: argparse.Namespace) -> None:
        ...
        if not remote_code:
            raise SystemExit("FUNASR_REMOTE_CODE/--remote-code is required")
...
def build_app(runtime: Runtime) -> FastAPI:
    ...
    def health() -> dict[str, Any]:
        return {"ok": True, "model": runtime.served_model, "checkpoint": runtime.checkpoint, "device": runtime.device}

    @app.get("/v1/models")
    def models() -> dict[str, Any]:
        return {"object": "list", "data": [{"id": runtime.served_model, "object": "model", "owned_by": "local-funasr"}]}
