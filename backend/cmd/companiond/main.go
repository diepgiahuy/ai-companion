...
func main() {
	...
	httpServer := &http.Server{
		Addr: address, Handler: ownerAuthFromEnvironment(deviceOriginGuard(service.Handler()), data, control, data, service.DeviceOnline, service.UpdateDeviceSettings), ReadHeaderTimeout: 5 * time.Second, IdleTimeout: 90 * time.Second,
	}
