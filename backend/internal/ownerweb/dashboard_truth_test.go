...
func TestDashboardUsesSimplifiedTruthfulProductSurface(t *testing.T) {
	...
	for _, forbidden := range []string{
		"/v1/owner/data/device/claim", "Claim Device", "v2.4.1", "SHA256 verified",
		"160.5 KiB", "PSRAM Codec", "10000000", "toggleAudio(", "checkOTA(", "triggerOTA(",
	} {
	...
	for _, mutation := range []string{
		"mutate('/v1/owner/data/budget'", "mutate('/v1/owner/data/savings-goal'",
		"mutate('/v1/owner/data/privacy'", "mutate('/v1/owner/data/device/config'",
	} {
